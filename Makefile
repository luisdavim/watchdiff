...
lint: lint-go lint-shell lint-dockerfile lint-yaml ## Run all available linters
...
## Documentation:
docs: fmt usagedoc gomarkdoc-pkg gomarkdoc-pkg-k8swatcher gomarkdoc-cmd ## Generate project documentation
	rm -rf docs
	mkdir -p docs
